      ...
      <div class="flex flex-col space-y-8 justify-between">
        ...
        <div class="flex flex-col space-y-4">
          <div class="inline-flex space-x-2 items-center">
            ...
            />
            <span class="">
              Robert Bosch Straße 74196 Neuenstadt am Kocher
            </span>
          </div>
          <div class="inline-flex space-x-2 items-center">
            <img src="../assets/phone-svgrepo-com.svg" class="w-7 h-7" />
            <span class="">+40 2525234</span>
          </div>
          <div class="inline-flex space-x-2 items-center">
            <img src="../assets/clock-svgrepo-com.svg" class="w-7 h-7" />
            <span class="">Mon-Fri 09:00-17:00</span>
          </div>
        </div>
        <div></div>
      </div>
      <div class="bg-white rounded-xl shadow-lg p-8 text-gray-600 md:w-96">
        <form class="flex flex-col space-y-4">
          ...
          <button
            class="inline-block self-end bg-mainColor text-white font-bold rounded-lg px-6 py-2 uppercase text-sm"
          >
            Send Message
          </button>
        </form>
